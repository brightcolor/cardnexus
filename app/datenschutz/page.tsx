  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="mx-auto max-w-2xl px-4 py-16">
        ...
        <p className="text-sm text-gray-400 mb-8">Stand: {new Date().toLocaleDateString("de-DE", { year: "numeric", month: "long" })}</p>
        ...
        <div className="space-y-8 text-gray-700 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">3. Zweck der Verarbeitung</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">4. Speicherort</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">6. Deine Rechte</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">7. Beschwerderecht</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-gray-900 mb-2">8. Löschfristen</h2>
